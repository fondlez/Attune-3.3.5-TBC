...
-- INTERFACE
Lang["Credits"] = "Yvely가 2.4.3으로 포팅했습니다. 그래도 Cixi에 대한 모든 크레딧.\n원본 크레딧:\n애드온을 테스트하는 동안 길드 |cffffd100<Divine Heresy>|r 의 지원과 격려에 매우 감사합니다, 그리고 |cffffd100Bushido @ Pyrewood Village|r 에 대한 도움을 주신 BOB에게 큰 찬사를 보냅니다!\n\n 또한 번역을 해주신 덕분에:\n  - 독어 번역: |cffffd100Sumaya @ Razorfen DE|r\n  - 노어 번역: |cffffd100Greymarch Guild @ Flamegor RU|r\n  - 스페인어 번역: |cffffd100Coyu @ Pyrewood Village EU|r\n  - 중국어 간체 번역: |cffffd100ly395842562|r 과 |cffffd100Icyblade|r\n  - 중국어 번체 번역: |cffffd100DayZ|r @ Ivus TW|r\n  - 한글 번역: |cffffd100Drix @ 아즈샤라 KR|r\n\n/Hug Cixi/Gaya @ Remulos Horde 드림"
Lang["Mini"] = "작게"
Lang["Maxi"] = "크게"
Lang["Version"] = "Attune v##VERSION## by Cixi@Remulos, 2.4.3 Yvely@어디에나 포트"
Lang["Splash"] = "v##VERSION## by Cixi@Remulos, 2.4.3 Yvely@어디에나 포트. /attune 입력"
Lang["Survey"] = "조회"
Lang["Guild"] = "길드"
Lang["Party"] = "파티"
Lang["Raid"] = "공격대"
...
Lang["AbandonedStep"] = "버려진 ##TYPE## |cffe4e400##STEP##|r 현 단계 |cffe4e400##NAME##|r."
...
Lang["Help2"] = "|cfffff700/attune|r을 실행하여 시작하거나 |cfffff700/attune commands|r을 실행하여 슬래시 명령을 실행합니다."
...
Lang["HelpCommands"] = "사용 가능한 명령은 다음과 같습니다."
Lang["HelpCommands1"] = "|cfffff700/attune info|r - 애드온에 대한 정보 얻기"
Lang["HelpCommands3"] = "|cfffff700/attune survey|r - 업데이트된 attune 정보를 얻기 위해 길드를 조사하십시오."
Lang["HelpCommands4"] = "|cfffff700/attune silentsurvey|r - 위와 같지만 은밀하다."
Lang["HelpCommands5"] = "|cfffff700/attune sync|r - 동기화 요청 보내기"
Lang["HelpCommands6"] = "|cfffff700/attune raid|r - 공격대 플래너 프레임 표시"
Lang["HelpCommands7"] = "|cfffff700/attune raidplanner|r - 같은 상기와"
Lang["HelpCommands8"] = "|cfffff700/attune planner|r - 같은 상기와"
Lang["HelpCommands9"] = "|cfffff700/attune <name>|r - 특정 플레이어 조사"
...
--v220
Lang["CooldownsCleared"] = "동기화 및 설문조사 쿨다운이 삭제되었습니다."
Lang["My Toons"] = "내 케릭터"
Lang["Rep"] = "평판"
Lang["This Toon"] = "이 툰"
...
Lang["Request rejected"] = "요청 거부됨, ##PLAYER## 에서 다시 시도할 수 있습니다 ##TIME## 초. ##EXTRA##"
Lang["Request disallowed"] = "요청이 거부되었습니다. 대상이 동기화 요청을 수락하지 않습니다."
Lang["Request cooldown"] = "요청이 거부되었습니다. 대기 중입니다. 나중에 다시 시도하거나 수신자에게 쿨다운을 취소하도록 요청하세요."
Lang["DeserializeError"] = "동기화 데이터를 구문 분석하는 동안 오류가 발생했습니다. 전송 중에 손상되었을 수 있습니다."
Lang["RejectExtra"] = "플레이어를 무시하면 모든 것이 차단됩니다."
...
Lang["PlaySounds_TEXT"] = "소리 재생"
Lang["PlaySounds_DESC"] = "Attune 이벤트에서 사운드를 재생합니다."
...
Lang["AllowSyncReq_TEXT"] = "동기화 요청 허용"
Lang["AllowSyncReq_DESC"] = "비활성화된 경우 동기화 요청을 완전히 비활성화합니다."
Lang["SyncReqCooldown_TEXT"] = "동기 쿨다운"
Lang["SyncReqCooldown_DESC"] = "허용된 각 동기화 요청 사이의 시간(초)입니다."
...
Lang["ShowGuildies_TEXT"] = "조율 단계에서 길드원 표시"
Lang["ShowGuildies_DESC"] = "현재 해당 조율 단계에 있는 길드원 목록을 단계 툴팁에 표시합니다."
Lang["ShowGuildiesCount_TEXT"] = "길드원 수"
Lang["ShowGuildiesCount_DESC"] = "각 조율 단계에서 표시되는 최대 길드원을 설정합니다."
Lang["ShowAltsInstead_TEXT"] = "길드원 대신 내 부케만 표시"
Lang["ShowAltsInstead_DESC"] = "현재 접속한 케릭터와 같은 단계인 길드원 대시 나의 부케들만 표시"
Lang["HeroicRequireHonored_TEXT"] = "영웅은 명예만 필요합니다."
Lang["HeroicRequireHonored_DESC"] = "영웅 던전이 열쇠에 대해서만 명예를 요구하는 경우 이 상자를 선택하십시오."
...
Lang["Hydraxian Waterlords"] = "히드락시안 물의 군주"
Lang["Old Hillsbrad"] = "옛 언덕마루"
Lang["Blade's Edge Mountains"] = "블레이드 엣지 산맥"
Lang["Blade's Edge Mountain"] = "블레이드 엣지 산맥"
Lang["Flamewaker"] = "화염꼬리"
--WOTLK
Lang["Wrath of the Lich King"] = "리치 왕의 분노"


-- Proper locations for detection of raid attunement
Lang["Mount Hyjal LOC"] = "하이잘 정상"
Lang["The Eye LOC"] = "폭풍우 요새"
