...
-- INTERFACE
Lang["Credits"] = "Porté en 2.4.3 par Yvely. Tous les crédits à Cixi cependant.\nCrédits originaux:\nUn énorme MERCI à ma guilde |cffffd100<Divine Heresy>|r pour leur soutien et patience pendant les tests de l'addon, et merci à |cffffd100Bushido @ Pyrewood Village|r pour l'aide sur TBC!\n\nMerci beaucoup également aux traducteurs:\n  - Traduction allemande: |cffffd100Sumaya @ Razorfen DE|r\n  - Traduction russe: |cffffd100Guilde Greymarch @ Flamegor RU|r\n  - Traduction espagnole: |cffffd100Coyu @ Pyrewood Village EU|r\n  - Traduction chinoise (simp.): |cffffd100ly395842562|r et |cffffd100Icyblade|r\n  - Traditional chinoise (trad.): |cffffd100DayZ|r @ Ivus TW|r\n  - Traduction coréenne: |cffffd100Drix @ Azshara KR|r\n\n/Hug de la part Cixi/Gaya @ Remulos Horde"
Lang["Mini"] = "Mini"
Lang["Maxi"] = "Élargi"
Lang["Version"] = "Attune v##VERSION## par Cixi@Remulos, Porté en 2.4.3 par Yvely@Partout"
Lang["Splash"] = "v##VERSION## par Cixi@Remulos, Porté en 2.4.3 par Yvely@Partout. Tapez /attune pour commencer."
Lang["Survey"] = "Sondage"
Lang["Guild"] = "Guilde"
Lang["Party"] = "Groupe"
Lang["Raid"] = "Raid"
...
Lang["AbandonedStep"] = "ABANDONNÉ ##TYPE## |cffe4e400##STEP##|r pour l'accès |cffe4e400##NAME##|r."
...
Lang["Help2"] = "Tapez |cfffff700/attune|r pour commencer ou |cfffff700/attune commands|r pour les commandes slash."
...
Lang["HelpCommands"] = "Les commandes disponibles sont: "
Lang["HelpCommands1"] = "|cfffff700/attune info|r - obtenir des informations sur l'addon"
Lang["HelpCommands3"] = "|cfffff700/attune survey|r - interrogez votre guilde pour obtenir des informations d'harmonisation mises à jour"
Lang["HelpCommands4"] = "|cfffff700/attune silentsurvey|r - le même que ci-dessus mais sournois"
Lang["HelpCommands5"] = "|cfffff700/attune sync|r - envoyer une demande de synchronisation"
Lang["HelpCommands6"] = "|cfffff700/attune raid|r - afficher le cadre du planificateur de raid"
Lang["HelpCommands7"] = "|cfffff700/attune raidplanner|r - comme ci-dessus"
Lang["HelpCommands8"] = "|cfffff700/attune planner|r - comme ci-dessus"
Lang["HelpCommands9"] = "|cfffff700/attune <name>|r - enquêter sur un joueur en particulier"
...
--v220
Lang["CooldownsCleared"] = "Temps de recharge de synchronisation et d'enquête effacés"
Lang["My Toons"] = "Mes personnages"
Lang["Rep"] = "Rep"
Lang["This Toon"] = "Ce dessin animé"
...
Lang["Request rejected"] = "Demande rejetée, ##PLAYER## peut réessayer dans ##TIME## secondes. ##EXTRA##"
Lang["Request disallowed"] = "Demande rejetée. La cible n'accepte pas les demandes de synchronisation."
Lang["Request cooldown"] = "Demande rejetée. Vous êtes en recharge. Réessayez plus tard ou demandez au destinataire d'effacer les temps de recharge."
Lang["DeserializeError"] = "Erreur lors de l'analyse des données de synchronisation - potentiellement corrompues en transit."
Lang["RejectExtra"] = "gnorer le joueur lui bloquera tout."
...
Lang["PlaySounds_TEXT"] = "Jouer des sons"
Lang["PlaySounds_DESC"] = "Jouez des sons sur les événements Attune."
...
Lang["AllowSyncReq_TEXT"] = "Autoriser la demande de synchronisation"
Lang["AllowSyncReq_DESC"] = "Désactive complètement les demandes de synchronisation si elles sont désactivées"
Lang["SyncReqCooldown_TEXT"] = "Temps de recharge de la synchronisation"
Lang["SyncReqCooldown_DESC"] = "Le nombre de secondes entre chaque demande de synchronisation autorisée."
...
Lang["ShowGuildies_TEXT"] = "Afficher les membres de la guilde sur les étapes d'harmonisation"
Lang["ShowGuildies_DESC"] = "Affiche dans l'info-bulle de l'étape une liste des membres de la guilde qui sont actuellement à cette étape d'harmonisation."
Lang["ShowGuildiesCount_TEXT"] = "Nombre de compagnons de guilde"
Lang["ShowGuildiesCount_DESC"] = "Définit un maximum de membres de guilde affichés à chaque étape d'harmonisation."
...
Lang["HeroicRequireHonored_TEXT"] = "Les héroïques ne nécessitent que d'être honorés"
Lang["HeroicRequireHonored_DESC"] = "Cochez cette case si les donjons héroïques ne nécessitent que d'être honorés pour les clés."
...
Lang["Hydraxian Waterlords"] = "Les Hydraxiens"
Lang["Old Hillsbrad"] = "Vieille Hautebrande"
Lang["Blade's Edge Mountains"] = "Montagnes du Tranchant"
Lang["Blade's Edge Mountain"] = "Montagnes du Tranchant"
Lang["Flamewaker"] = "Allume-flammes"
--WOTLK
Lang["Wrath of the Lich King"] = "La Colère du Roi-Liche"


-- Proper locations for detection of raid attunement
Lang["Mount Hyjal LOC"] = "Sommet d'Hyjal"
Lang["The Eye LOC"] = "Donjon de la Tempête"

-- GENERIC
Lang["Reach level"] = "Atteindre niveau"
Lang["Attuned"] = "Accès débloqué"
Lang["Attune"] = "Accès débloqué"
