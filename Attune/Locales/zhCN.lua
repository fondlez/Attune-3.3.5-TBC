...
Lang["AbandonedStep"] = "弃 ##TYPE## |cffe4e400##STEP##|r 为了协调 |cffe4e400##NAME##|r."
...
Lang["Help2"] = "运行 |cfffff700/attune|r 开始。或 |cfffff700/attune commands|r 用于斜杠命令"
...
Lang["HelpCommands1"] = "|cfffff700/attune info|r - 获取有关插件的信息"
Lang["HelpCommands3"] = "|cfffff700/attune survey|r - 调查您的公会以获取最新的协调信息"
Lang["HelpCommands4"] = "|cfffff700/attune silentsurvey|r - 与上面相同但偷偷摸摸"
Lang["HelpCommands5"] = "|cfffff700/attune sync|r - 发送同步请求"
Lang["HelpCommands6"] = "|cfffff700/attune raid|r - 显示突袭计划框架"
Lang["HelpCommands7"] = "|cfffff700/attune raidplanner|r - 同上"
Lang["HelpCommands8"] = "|cfffff700/attune planner|r - 同上"
Lang["HelpCommands9"] = "|cfffff700/attune <name>|r - 调查特定玩家"
...
--v220
Lang["CooldownsCleared"] = "同步和调查冷却时间已清除"
Lang["My Toons"] = "我的角色"
Lang["Rep"] = "名声"
Lang["This Toon"] = "这个卡通"
...
Lang["Request rejected"] = "请求被拒绝，##PLAYER## 可以在##TIME## 秒后重试。 ##EXTRA##"
Lang["Request disallowed"] = "请求被拒绝。 目标不接受同步请求."
Lang["Request cooldown"] = "请求被拒绝。 你正在冷却。 稍后再试或要求收件人清除冷却时间。"
Lang["DeserializeError"] = "解析同步数据时出错 - 可能在传输过程中损坏。"
Lang["RejectExtra"] = "忽略玩家将阻止他们的一切。"
...
Lang["PlaySounds_TEXT"] = "播放声音"
Lang["PlaySounds_DESC"] = "在 Attune 事件上播放声音。"
...
Lang["AllowSyncReq_TEXT"] = "允许同步请求"
Lang["AllowSyncReq_DESC"] = "如果禁用则完全禁用同步请求"
Lang["SyncReqCooldown_TEXT"] = "同步冷却时间"
Lang["SyncReqCooldown_DESC"] = "每个允许的同步请求之间的秒数。"
...
Lang["ShowGuildies_TEXT"] = "在协调步骤上显示公会成员"
Lang["ShowGuildies_DESC"] = "在步骤工具提示中显示当前处于该协调步骤的公会成员列表。"
Lang["ShowGuildiesCount_TEXT"] = "公会人数"
Lang["ShowGuildiesCount_DESC"] = "设置每个协调步骤中显示的公会成员的最大值。"
Lang["ShowAltsInstead_TEXT"] = "显示替代列表，而不是公会成员"
Lang["ShowAltsInstead_DESC"] = "步骤工具提示将显示您当前在该使用权步骤中的所有替代项，而不是行会成员。"
Lang["HeroicRequireHonored_TEXT"] = "英雄主义只需要荣誉"
Lang["HeroicRequireHonored_DESC"] = "如果英雄地下城只需要尊敬的钥匙，请选中此框。"
...
Lang["Old Hillsbrad"] = "旧希尔斯布莱德"
Lang["Blade's Edge Mountains"] = "刀锋山"
Lang["Blade's Edge Mountain"] = "刀锋山"
Lang["Flamewaker"] = "火妖"
--WOTLK
...
Lang["Mount Hyjal LOC"] = "海加尔峰t"
Lang["The Eye LOC"] = "风暴要塞"
...
Lang["Q1_13432"] = "永恒水瓶"			-- https://cn.tbc.wowhead.com/?quest=13432
Lang["Q2_13432"] = "时光之穴的索莉多米要你从盘牙水库的瓦丝琪那里取回瓦丝琪的水瓶残馀，并从风暴要塞的凯尔萨斯·逐日者那里取回凯尔萨斯的水瓶残馀。"
