...
-- INTERFACE
Lang["Credits"] = "Portado a 2.4.3 por Yvely. Sin embargo, todos los créditos a Cixi.\nCréditos originales:\nMuchas gracias a mi hermandad |cffffd100<Divine Heresy>|r por su apoyo y comprensión mientras probaba el addon y mi agradecimiento a |cffffd100Bushido @ Pyrewood Village|r por la ayuda con la TBC!\n\n También, muchas, muchas, gracias a los traductores :\n  - Traducción Alemana: |cffffd100Sumaya @ Razorfen DE|r\n  - Traducción Rusa: |cffffd100Greymarch Guild @ Flamegor RU|r\n  - Traducción Española: |cffffd100Coyu @ Pyrewood Village EU|r\n  - Traducción China (simp.): |cffffd100ly395842562|r y |cffffd100Icyblade|r\n  - Traducción China (trad.): |cffffd100DayZ|r @ Ivus TW|r\n  - Traducción coreana: |cffffd100Drix @ Azshara KR|r\n\n/Hug de Cixi/Gaya @ Remulos Horde"
Lang["Mini"] = "Mini"
Lang["Maxi"] = "Maxi"
Lang["Version"] = "Attune v##VERSION## de Cixi@Remulos, 2.4.3 port por Yvely@Everywhere"
Lang["Splash"] = "v##VERSION## de Cixi@Remulos, 2.4.3 port por Yvely@Everywhere. Escribe /attune para empezar."
Lang["Survey"] = "Sondear"
...
Lang["AbandonedStep"] = "ABANDONADO ##TYPE## |cffe4e400##STEP##|r para la armonización de |cffe4e400##NAME##|r."
...
Lang["Help2"] = "Ejecuta |cfffff700/attune|r para empezar o |cfffff700/attune commands|r para comandos de barra."
...
Lang["HelpCommands"] = "Los comandos disponibles son:"
Lang["HelpCommands1"] = "|cfffff700/attune info|r - obtener información sobre el complemento"
Lang["HelpCommands3"] = "|cfffff700/attune survey|r - encuesta a tu gremio para obtener información actualizada de attune"
Lang["HelpCommands4"] = "|cfffff700/attune silentsurvey|r - lo mismo que arriba pero disimulado"
Lang["HelpCommands5"] = "|cfffff700/attune sync|r - enviar una solicitud de sincronización"
Lang["HelpCommands6"] = "|cfffff700/attune raid|r - mostrar el marco del planificador de incursiones"
Lang["HelpCommands7"] = "|cfffff700/attune raidplanner|r - Lo mismo que arriba"
Lang["HelpCommands8"] = "|cfffff700/attune planner|r - Lo mismo que arriba"
Lang["HelpCommands9"] = "|cfffff700/attune <name>|r - Encuestar a un jugador específico"
...
--v220
Lang["CooldownsCleared"] = "Tiempos de reutilización de sincronización y encuesta borrados"
Lang["My Toons"] = "Mis personajes"
Lang["Rep"] = "Rep"
Lang["This Toon"] = "Este personajes"
...
Lang["Request rejected"] = "Solicitud rechazada, ##PLAYER## puede volver a intentarlo en ##TIME## segundos. ##EXTRA##"
Lang["Request disallowed"] = "Solicitud rechazada. Target no acepta solicitudes de sincronización."
Lang["Request cooldown"] = "Solicitud rechazada. Estás en enfriamiento. Vuelva a intentarlo más tarde o pídale al destinatario que borre los tiempos de reutilización."
Lang["DeserializeError"] = "Error al analizar los datos de sincronización: potencialmente corruptos en tránsito."
Lang["RejectExtra"] = "Ignorar al jugador bloqueará todo de ellos."
...
Lang["PlaySounds_TEXT"] = "Reproducir sonidos"
Lang["PlaySounds_DESC"] = "Reproduce sonidos en eventos de Attune."
...
Lang["AllowSyncReq_TEXT"] = "Permitir solicitud de sincronización"
Lang["AllowSyncReq_DESC"] = "Deshabilita completamente las solicitudes de sincronización si está deshabilitado"
Lang["SyncReqCooldown_TEXT"] = "Enfriamiento de sincronización"
Lang["SyncReqCooldown_DESC"] = "La cantidad de segundos entre cada solicitud de sincronización permitida para usted."
...
Lang["ShowGuildies_TEXT"] = "Mostrar a los miembros del gremio en los pasos de armonización"
Lang["ShowGuildies_DESC"] = "Muestra en la información sobre herramientas del paso una lista de los miembros del gremio que se encuentran actualmente en ese paso de sintonía."
Lang["ShowGuildiesCount_TEXT"] = "Recuento de compañeros de gremio"
Lang["ShowGuildiesCount_DESC"] = "Establece un máximo de miembros del gremio mostrados en cada paso de sintonía."
...
Lang["HeroicRequireHonored_TEXT"] = "Los actos heroicos solo requieren honor"
Lang["HeroicRequireHonored_DESC"] = "Marca esta casilla si las mazmorras heroicas solo requieren honor por las llaves."
...
Lang["Hydraxian Waterlords"] = "Srs. del Agua de Hydraxis"
Lang["Old Hillsbrad"] = "Viejo Trabalomas"
Lang["Blade's Edge Mountains"] = "Montañas del Filo de la Espada"
Lang["Blade's Edge Mountain"] = "Montañas del Filo de la Espada"
Lang["Flamewaker"] = "despiertallamas"


-- Proper locations for detection of raid attunement
Lang["Mount Hyjal LOC"] = "Cima Hyjal"
Lang["The Eye LOC"] = "El Castillo de la Tempestad"

-- GENERIC
Lang["Reach level"] = "Alcanza nivel"
Lang["Attuned"] = "Armonizado"
Lang["Attune"] = "Armonizado"
