...
Lang["AbandonedStep"] = "棄 ##TYPE## |cffe4e400##STEP##|r 用於協調 |cffe4e400##NAME##|r。"
...
Lang["Help2"] = "運行 |cfffff700/attune|r 啟動或運行 |cfffff700/attune commands|r 斜杠命令"
...
Lang["HelpCommands"] = "可用的命令是："
Lang["HelpCommands1"] = "|cfffff700/attune info|r - 獲取有關插件的信息"
Lang["HelpCommands3"] = "|cfffff700/attune survey|r - 調查您的公會以獲取最新的協調信息"
Lang["HelpCommands4"] = "|cfffff700/attune silentsurvey|r - 與上面相同但偷偷摸摸"
Lang["HelpCommands5"] = "|cfffff700/attune sync|r - 發送同步請求"
Lang["HelpCommands6"] = "|cfffff700/attune raid|r - 顯示突襲計劃框架"
Lang["HelpCommands7"] = "|cfffff700/attune raidplanner|r - 同上"
Lang["HelpCommands8"] = "|cfffff700/attune planner|r - 同上"
Lang["HelpCommands9"] = "|cfffff700/attune <name>|r - 調查特定玩家"
...
--v220
Lang["CooldownsCleared"] = "同步和調查冷卻時間已清除"
Lang["My Toons"] = "我的角色"
Lang["Rep"] = "名聲"
Lang["This Toon"] = "這個卡通"
...
Lang["Request rejected"] = "請求被拒絕，##PLAYER## 可以在##TIME## 秒後重試。##EXTRA##"
Lang["Request disallowed"] = "請求被拒絕。 目標不接受同步請求。"
Lang["Request cooldown"] = "請求被拒絕。 你正在冷卻。 稍後再試或要求收件人清除冷卻時間。"
Lang["DeserializeError"] = "解析同步數據時出錯 - 可能在傳輸過程中損壞。"
Lang["RejectExtra"] = "忽略玩家將阻止他們的一切。"
...
Lang["PlaySounds_TEXT"] = "播放聲音"
Lang["PlaySounds_DESC"] = "在 Attune 事件上播放聲音。"
...
Lang["AllowSyncReq_TEXT"] = "允許同步請求"
Lang["AllowSyncReq_DESC"] = "如果禁用則完全禁用同步請求"
Lang["SyncReqCooldown_TEXT"] = "同步冷卻時間"
Lang["SyncReqCooldown_DESC"] = "每個允許的同步請求之間的秒數。"
...
Lang["ShowGuildies_TEXT"] = "顯示公會成員的調諧步驟"
Lang["ShowGuildies_DESC"] = "在步驟工具提示中顯示當前處於該協調步驟的公會成員列表。"
Lang["ShowGuildiesCount_TEXT"] = "公會人數"
Lang["ShowGuildiesCount_DESC"] = "設置每個協調步驟中顯示的公會成員的最大值。"
Lang["ShowAltsInstead_TEXT"] = "顯示備用角色，而不是公會成員"
Lang["ShowAltsInstead_DESC"] = "步驟工具提示將顯示您當前在該使用權步驟中的所有備用角色，而不是公會成員。"
Lang["HeroicRequireHonored_TEXT"] = "英雄主義只需要榮譽"
Lang["HeroicRequireHonored_DESC"] = "如果英雄地下城只需要尊敬的鑰匙，請選中此框。"
...
Lang["Hydraxian Waterlords"] = "海达希亚水元素"
Lang["Old Hillsbrad"] = "舊希爾斯布萊德"
Lang["Blade's Edge Mountains"] = "刀鋒山"
Lang["Blade's Edge Mountain"] = "刀鋒山"
Lang["Flamewaker"] = "火妖"
--WOTLK
...
Lang["Mount Hyjal LOC"] = "海加爾山"
Lang["The Eye LOC"] = "風暴要塞"
...
Lang["Q1_13432"] = "永恆之瓶"			-- https://cn.tbc.wowhead.com/?quest=13432
Lang["Q2_13432"] = "時光之穴的索芮朵蜜要你去從盤牙蓄湖的瓦許女士身上取得瓦許的殘存之瓶，從風暴要塞的凱爾薩斯·逐日者身上取得凱爾薩斯的殘存之瓶。"
